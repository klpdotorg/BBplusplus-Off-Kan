...
Game.appLoginEditScreen.prototype = {
	...
	create: function (game) {
		...
		//* nEED to change this ****
		_this.fullSize = 307651189;//,302978124//87798759

		//BBplusplusOffKan//119,941,833 kannada + 18,76,72,332,  //95,186,236
		_this.zipFiles = [["Assets1.zip", 981561], ["Assets2.zip", 87798759], ["Assets4.zip", 95186236], ["KannadaquestionSounds.zip", 119941833],["sounds.zip", 3742800]];// old = 3683747
		...
		if (_this.user.language == "English") {
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/Kannada", _this.user.language + "/KannadaquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
